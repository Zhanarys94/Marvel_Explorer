package kz.zhanarys.domain.entities.dto
...
fun HeroDto.transformToCharacterEntity(): CharacterEntity {
    return CharacterEntity(
        id!!, name!!,  thumbnail!!.path!!.replace("http://", "https://"), ".${thumbnail.extension!!}", shortInfo!!
    )
}